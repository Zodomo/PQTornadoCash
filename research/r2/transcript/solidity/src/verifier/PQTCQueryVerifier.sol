...
contract PQTCQueryVerifier {
    ...
    constructor(uint16 count) { require(count >= 12 && count <= 20, "query count"); HALF = count; }
    ...
    function verifySecondHalf(
        ...
        (next,,) = _verifyHalf(proof, cursor, uint16(32 - HALF), context, zetaAggregate, nextAggregate, false);
    }
