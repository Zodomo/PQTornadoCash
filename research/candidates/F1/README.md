# F1: KoalaBear / degree 4

Status: **BENCHMARK_ONLY**. Challenge field: `x^4 - 3`.
...
HIGH_LIBRARY_MEDIUM_INTEGRATION: optimized pinned field and permutation code exist; the frozen PQTornado relation has not been ported.
