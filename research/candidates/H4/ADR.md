...
Execute the valid primitive benchmark; retain the one-call node failure. Stopped: two children require 22 lanes and four controls require 26 > 24.
...
- 5× node-permutation reduction: NOT PASSED — H4 has no application node permutation count.
...
- Generic security of at least 100 bits: PASS — ideal quantum collision ceiling 113.325 bits and hidden-part Grover ceiling 200.895 bits; limiting generic ceiling 113.325 bits. This is a necessary width heuristic only, not qualification.
- No structural attack: FAIL — the exact 2026 width-24, d=11 compression round-skip result applies.
