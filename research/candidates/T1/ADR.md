...
NOT_SELECTED. Fewer hash calls than T0, but T3 measures fewer calls while making challenge boundaries explicit.

## Context

One length-and-count-delimited absorb for each logical field array; scalars and commitments remain typed items. The exact intended claim order and challenge boundaries are recorded in `../../cryptanalysis/transcript/SPEC.md`. The comparison is frozen v0.3 at Plonky3 `3152b14a89067c83775a8076cc262ffc48a1fd7c`.
