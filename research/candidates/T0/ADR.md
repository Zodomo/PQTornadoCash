...
REFERENCE_CONTROL. Retained as the exact comparison control; it is not a new deployment candidate.

## Context

Production-compatible initialization and one K512 absorb per canonical field or commitment. The exact intended claim order and challenge boundaries are recorded in `../../cryptanalysis/transcript/SPEC.md`. The comparison is frozen v0.3 at Plonky3 `3152b14a89067c83775a8076cc262ffc48a1fd7c`.
