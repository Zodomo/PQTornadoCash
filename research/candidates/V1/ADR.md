...
Use the shared Rust/Solidity kernels and fail-closed driver. Preserve canonical encodings and protocol ordering. Horner and forward streaming eliminate the power vector; reverse Horner is permitted only where coefficient order is fixed before alpha.
