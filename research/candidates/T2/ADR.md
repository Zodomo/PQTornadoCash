...
REJECTED_EFFICIENCY. The extra item digest increases Keccak work without an evidenced full-path benefit.

## Context

A typed, length-delimited item K512 digest followed by a K512 state update. The exact intended claim order and challenge boundaries are recorded in `../../cryptanalysis/transcript/SPEC.md`. The comparison is frozen v0.3 at Plonky3 `3152b14a89067c83775a8076cc262ffc48a1fd7c`.
