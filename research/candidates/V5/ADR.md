# V5: Fixed, derived, and checked calldata tables
...
Use the shared Rust/Solidity kernels and fail-closed driver. Preserve canonical encodings and protocol ordering. Code-embedded powers, in-EVM derivation, and recurrence-checked calldata are measured separately with deployment/runtime effects.
