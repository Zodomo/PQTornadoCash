# V8: Uniquely decodable canonical proof codecs
...
Use the shared Rust/Solidity kernels and fail-closed driver. Preserve canonical encodings and protocol ordering. 31-bit packing has exact section lengths, canonical field rejection, and zero terminal padding. Derived-value omission is allowed only when recomputed from prior transcript state.
