# V9: Asymmetric query split and AIR placement
...
Use the shared Rust/Solidity kernels and fail-closed driver. Preserve canonical encodings and protocol ordering. All required 8/24 through 16/16 splits and both AIR placements are projected against one component model; minimum margin, not equal count, is optimized.
