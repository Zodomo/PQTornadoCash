...
Highest-priority research hypothesis; never security-qualified by this package. The layout exercise uses 24 generic payload lanes, four controls, and four fixed zero lanes, but note/nullifier payloads omit scope and frozen semantic secret/trapdoor widths and are not application-complete.
...
- 5× node-permutation reduction: PASS — H0 uses 11 node permutations; H5 uses 1; 11.000× reduction.
...
- Generic security of at least 100 bits: PASS — ideal quantum collision ceiling 123.628 bits and hidden-part Grover ceiling 309.069 bits; limiting generic ceiling 123.628 bits. This is a necessary width heuristic only, not qualification.
