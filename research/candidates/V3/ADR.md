...
Use the shared Rust/Solidity kernels and fail-closed driver. Preserve canonical encodings and protocol ordering. Every big-endian u32 is rejected at p before it contributes to the accumulator; there is no reduction modulo p.
