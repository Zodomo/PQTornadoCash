# PQTornado hash and transcript external-review packet

**Packet:** `sp10-sp30-digest-security-2026-09-04`  
**Classification:** `INTERNAL_PACKET_READY_EXTERNAL_REVIEW_OPEN`  
**Candidate disposition:** `NO_AIR_CANDIDATE`  
...
The compressed vector bundle is referenced, not copied: `research/candidates/hash-compression-common/vectors/cross-language.json.zst`, compressed SHA-256 `d439dfcaf7ff1874528fe37f8a0a66fbb18425d45bda4aad41c8c1cd3d1d64e2`. Its metadata records 18,146 Rust/TypeScript matches, only eight Solidity anchors, full three-language parity `NOT_EVALUATED`, misuse suite `NOT_EVALUATED`, and constant comparison `NOT_RETAINED`.
...
|---|---|---|---|
| poseidon2 | Poseidon2, ePrint 2023/323, especially section 3.1 | https://eprint.iacr.org/2023/323 | `SOURCE_PIN_RETAINED_REVIEW_APPLICABILITY_OPEN` |
| subspace-trails | Poseidon/Neptune subspace-trail cryptanalysis, ToSC 2025(2), DOI 10.46586/tosc.v2025.i2.34-86; ePrint 2025/954 sections 4-5 | https://eprint.iacr.org/2025/954 | `SOURCE_PIN_RETAINED_REVIEW_APPLICABILITY_OPEN` |
| skipping-class | Skipping Class, ePrint 2026/306, especially Lemma 4.5 and sections 4 and 6 | https://eprint.iacr.org/2026/306 | `SOURCE_PIN_RETAINED_REVIEW_APPLICABILITY_OPEN` |
| rpo-m31 | RPO-M31, ePrint 2024/1635 | https://eprint.iacr.org/2024/1635 | `SOURCE_PIN_RETAINED_REVIEW_APPLICABILITY_OPEN` |
| bht | Brassard-Hoyer-Tapp collision search, arXiv quant-ph/9705002 | https://arxiv.org/abs/quant-ph/9705002 | `GENERIC_MODEL_SOURCE_ONLY` |
| grover | Grover search, arXiv quant-ph/9605043 | https://arxiv.org/abs/quant-ph/9605043 | `GENERIC_MODEL_SOURCE_ONLY` |
| johnson | Correlated-agreement/Johnson-bound source, ePrint 2025/2055 Theorem 4.2 | https://eprint.iacr.org/2025/2055 | `CONDITIONAL_THEOREM_SOURCE` |
| random-words | Random-words source, ePrint 2025/2010 section 1.5 | https://eprint.iacr.org/2025/2010 | `CONJECTURAL_SOURCE_EXCLUDED_FROM_TARGET_RECOMMENDATIONS` |
...
|---|---|---|
| `plan` | `PQTC_NEXT_GENERATION_RESEARCH_PLAN.md` | `2da7ab2b570695da4f05d23c135cae1911459b77ad5cc6c2981e6ab7e886353f` |
| `sp10-review` | `research/cryptanalysis/poseidon2-compression/packet.json` | `2fb6d1ee541f85e64c24b866e8668cea27d1f0104b41924f5e809b648d698729` |
| `sp10-status` | `research/cryptanalysis/poseidon2-compression/status.json` | `f51c759ccc3cc063d677cfafd5bfdec5962fc526ae44d56677b58adc016e2e69` |
| `sp10-source-pin` | `research/cryptanalysis/poseidon2-compression/source-hashes.json` | `4a47937f60de6efd64ae88fca825a1268393177b52d748e81395f90e85375a30` |
| `sp10-constants` | `research/candidates/hash-compression-common/constants/pinned.json` | `73f92f5dd3076550927953dc13dcf97aba2ad544c7a9bb828acf89379ed72ad2` |
| `sp10-constant-derivation` | `research/candidates/hash-compression-common/scripts/compare-constants.py` | `250ce66ad7a82b80417b704befbb3912acb30af4e5922ce7757d9de4a5488c32` |
| `sp10-reference` | `research/candidates/hash-compression-common/reference/reference.ts` | `ba2400c7ad458e72656f536e570cea3a954f5a6e8480d7e2c86db9130a6be1db` |
| `sp10-rust` | `research/candidates/hash-compression-common/src/lib.rs` | `1add6a117f085236c0a978a3eab4180d6968c60f04028b505a50219bf0f77fb2` |
| `sp10-ceilings` | `research/candidates/hash-compression-common/security/analytical-ceilings.json` | `acd073d1fc73872ac671869ecaedaca4fe2434e0add9712326320a78ac19d6ea` |
| `sp10-operation-counts` | `research/candidates/hash-compression-common/native/operation-counts.json` | `b0b112b6e70300c3c15a0b627bba3f970e561e17916ded5d1adf926603b32897` |
| `sp10-vector-metadata` | `research/candidates/hash-compression-common/vectors/package.json` | `bff8cf5198934279cdd09e2266363bcd51656d68026fb05d1da002c14b381308` |
| `sp10-vectors` | `research/candidates/hash-compression-common/vectors/cross-language.json.zst` | `d439dfcaf7ff1874528fe37f8a0a66fbb18425d45bda4aad41c8c1cd3d1d64e2` |
| `sp30-spec` | `research/cryptanalysis/transcript/SPEC.md` | `0188887bc336de6d055dfe08bd2c38d117c3252d21b2c60c9304bace35e0f7c8` |
| `sp30-grammar` | `research/cryptanalysis/transcript/grammar.json` | `02a392a5f35682dcc81ac260a0d1fae8e9372659485842d5ec2a7e4279f4c50e` |
| `sp30-graph` | `research/cryptanalysis/transcript/claim-challenge-graph.json` | `4e7f6e3e46d040c637a5d288ca0a1dfad6a66daeff477a1e3f82da18de02859e` |
| `sp30-status` | `research/cryptanalysis/transcript/status.json` | `d47a1e35806186146f2abbcbbc46825d6a0fa688f884b7278061d75ec3f8dd2f` |
| `sp30-run` | `research/cryptanalysis/transcript/focused-run.json` | `783dfb0aa1ab369557c6c93f9f9c0f39c280db9172aabba8ed7f6b28426cdaeb` |
| `sp30-adr` | `research/cryptanalysis/transcript/ADR.md` | `263acd93c8b456b17b84cb98af5b3fed29144793a7cfa69650171c205d2217cf` |
| `sp30-v03-conformance` | `research/cryptanalysis/transcript/v03-conformance.json` | `f5839d7ed07d69fa49e931441cb388f07f3c5abd43198bc1b50b1815191cb855` |
| `sp30-baseline` | `research/cryptanalysis/transcript/baseline-evidence.json` | `0deca2b838b0b3219de626931ebc1fe8684b8ed726ec55329aab4ad9c6552c7f` |
| `digest-results` | `research/digest-width/results.json` | `7d525c0599f0fba8eadb6ce2f3a522b5b181144420bc468151e00abc2f020df3` |
| `digest-assumptions` | `research/digest-width/assumptions.md` | `24c66dbb1abdd01ffdb8e238107667830d4ff7eaa597b9c14331270bc5a3a060` |
| `digest-status` | `research/digest-width/status.json` | `a94e24e03b6b483e981530d9733a5c6b72572b68fcfad79e3eb284af6efbf370` |
| `security-formulas` | `research/security-model/formulas.md` | `7872f690f17467399f85d7953c72a28063a906096d8e1cd71fe01a6b7bb4eec4` |
| `security-manifest` | `research/security-model/manifests/v03-q32.json` | `c8b5c5520a23352262c29dd983e821d5aee2977fb302d83d869efe5eee238e65` |
| `security-result` | `research/security-model/v03-q32.json` | `64906f01d7a864d984346436519d5e89677ffc5a5988ca4e02feb6119c4b112f` |
| `security-status` | `research/security-model/status.json` | `18613d09f3921f479957f3fc423d4241f1028cd1981e1900a92e5da22ca0c90f` |
| `security-calculator` | `research/security-model/calculator/security_calculator.py` | `8a126a3f527266482044fe05e80c7834bcab2c2c29c8c09c16d7cf47981503ea` |
